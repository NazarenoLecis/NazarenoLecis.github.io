(function () {
  ...
  var text = {
    ...
    "Parti da anno e coorte, poi restringi il perimetro per ateneo, gruppo disciplinare, tipo di corso e classe di laurea. La vista dettagliata usa gli anni recenti; le serie storiche usano dati piu' aggregati e vanno piu' indietro nel tempo.": "Start from survey year and cohort, then narrow the scope by university, subject group, degree type and degree class. The detailed view uses recent years; the time series use more aggregated data and go further back in time.",
    ...
    "Anno di indagine, anni dalla laurea e coorte identificano il gruppo osservato.": "Survey year, years since graduation and cohort identify the observed group.",
    ...
    "Mappa della coorte selezionata": "Map of the selected cohort",
    ...
    "Nel focus Italia scegli regione e misura OMI. La Sardegna e' caricata di default; gli altri export regionali possono essere aggiunti dallo stesso repository dati.": "In the Italy focus, choose a region and an OMI measure. Sardinia is loaded by default; the other regional exports can be added from the same data repository.",
    ...
    "Scegli una regione e una misura: affitto medio, affitto mediano, prezzo di vendita medio o prezzo di vendita mediano. Quando sono presenti le geometrie, il grafico mostra una mappa comunale; altrimenti usa una classifica dei comuni con valori disponibili.": "Choose a region and a measure: average rent, median rent, average sale price or median sale price. When geometries are available, the chart shows a municipal map; otherwise it uses a ranking of municipalities with available values.",
    "Regione": "Region",
    ...
    "Affitto medio OMI": "Average OMI rent",
    "Affitto mediano OMI": "Median OMI rent",
    "Prezzo vendita medio OMI": "Average OMI sale price",
    "Prezzo vendita mediano OMI": "Median OMI sale price",
    ...
    "Rigenera gli export statici dal repository Crisi_abitativa o controlla che i file siano presenti in data/crisi-abitativa/eurostat/.": "Regenerate the static exports from the Crisi_abitativa repository or check that the files are present in data/crisi-abitativa/eurostat/.",
    "Export locale non disponibile": "Local export not available",
    "Focus locale non ancora esportato. Genera i JSON regionali dal repository Crisi_abitativa e salvali in data/crisi-abitativa/regions/.": "Local focus not exported yet. Generate the regional JSON files from the Crisi_abitativa repository and save them in data/crisi-abitativa/regions/.",
