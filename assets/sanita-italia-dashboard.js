(function () {
  ...
  function regionalMapMetricOptions(topic) {
    var metrics = {
      overview: [
        ...
        { value: "overview_stay_days_per_1000", label: "Giornate di degenza per 1.000 residenti" },
        { value: "overview_stay_days_per_1000_over65", label: "Giornate di degenza per 1.000 residenti 65+" },
        { value: "overview_stay_days_per_1000_over75", label: "Giornate di degenza per 1.000 residenti 75+" },
      ...
      activity: [
        ...
        { value: "activity_discharges_per_1000", label: "Dimissioni per 1.000 residenti" },
        { value: "activity_discharges_per_1000_over65", label: "Dimissioni per 1.000 residenti 65+" },
        { value: "activity_discharges_per_1000_over75", label: "Dimissioni per 1.000 residenti 75+" },
        { value: "activity_stay_days", label: "Giornate di degenza" },
        { value: "activity_stay_days_per_1000", label: "Giornate di degenza per 1.000 residenti" },
        { value: "activity_stay_days_per_1000_over65", label: "Giornate di degenza per 1.000 residenti 65+" },
        { value: "activity_stay_days_per_1000_over75", label: "Giornate di degenza per 1.000 residenti 75+" },
        { value: "activity_avg_los", label: "Degenza media" },
        { value: "activity_bed_utilization", label: "Utilizzo posti letto" },
        { value: "activity_beds_per_1000", label: "Posti letto per 1.000 residenti" },
        { value: "activity_beds_per_1000_over65", label: "Posti letto per 1.000 residenti 65+" },
        { value: "activity_beds_per_1000_over75", label: "Posti letto per 1.000 residenti 75+" },
  ...
  function regionalMapMetricConfig(metric) {
    ...
    if (metric === "overview_discharges_per_1000" || metric === "activity_discharges_per_1000") return { label: "Dimissioni per 1.000 residenti", tag: "ricoveri", format: formatDecimal, unit: "dimissioni per 1.000 residenti", rows: function () { return regionalMapSourceRows("discharges_per_1000", "activity_year", "dimissioni rapportate alla popolazione residente", "population_total"); }, sources: baseSources, note: "Rapporto tra dimissioni ospedaliere e popolazione residente. Serve a confrontare territori di dimensione diversa; non misura da solo qualita o appropriatezza." };
    if (metric === "overview_discharges_per_1000_over65" || metric === "activity_discharges_per_1000_over65") return { label: "Dimissioni per 1.000 residenti 65+", tag: "ricoveri", format: formatDecimal, unit: "dimissioni per 1.000 residenti 65+", rows: function () { return regionalMapSourceRows("discharges_per_1000_over65", "activity_year", "dimissioni rapportate alla popolazione 65+", "population_65_plus"); }, sources: baseSources, note: "Rapporto tra dimissioni ospedaliere e residenti di 65 anni e oltre; non significa che tutte le dimissioni riguardino over 65." };
    if (metric === "overview_discharges_per_1000_over75" || metric === "activity_discharges_per_1000_over75") return { label: "Dimissioni per 1.000 residenti 75+", tag: "ricoveri", format: formatDecimal, unit: "dimissioni per 1.000 residenti 75+", rows: function () { return regionalMapSourceRows("discharges_per_1000_over75", "activity_year", "dimissioni rapportate alla popolazione 75+", "population_75_plus"); }, sources: baseSources, note: "Rapporto tra dimissioni ospedaliere e residenti di 75 anni e oltre; utile per leggere la pressione relativa nei territori piu anziani." };
    if (metric === "overview_stay_days_per_1000" || metric === "activity_stay_days_per_1000") return { label: "Giornate di degenza per 1.000 residenti", tag: "ricoveri", format: formatDecimal, unit: "giornate per 1.000 residenti", rows: function () { return regionalMapDerivedRows(function (row) { var value = toNumber(row.stay_days); var population = toNumber(row.population_total); return value !== null && population ? value / population * 1000 : null; }, "activity_year", "giornate di degenza rapportate alla popolazione residente", "population_total"); }, sources: baseSources, note: "Rapporto tra giornate di degenza e popolazione residente. Aiuta a leggere il carico ospedaliero relativo, ma dipende da case mix e durata dei ricoveri." };
    if (metric === "overview_stay_days_per_1000_over65" || metric === "activity_stay_days_per_1000_over65") return { label: "Giornate di degenza per 1.000 residenti 65+", tag: "ricoveri", format: formatDecimal, unit: "giornate per 1.000 residenti 65+", rows: function () { return regionalMapDerivedRows(function (row) { var value = toNumber(row.stay_days); var population = toNumber(row.population_65_plus); return value !== null && population ? value / population * 1000 : null; }, "activity_year", "giornate di degenza rapportate alla popolazione 65+", "population_65_plus"); }, sources: baseSources, note: "Rapporto tra giornate di degenza e residenti 65+. Non significa che tutte le giornate siano di pazienti over 65; e un denominatore per confrontare regioni con eta diverse." };
    if (metric === "overview_stay_days_per_1000_over75" || metric === "activity_stay_days_per_1000_over75") return { label: "Giornate di degenza per 1.000 residenti 75+", tag: "ricoveri", format: formatDecimal, unit: "giornate per 1.000 residenti 75+", rows: function () { return regionalMapDerivedRows(function (row) { var value = toNumber(row.stay_days); var population = toNumber(row.population_75_plus); return value !== null && population ? value / population * 1000 : null; }, "activity_year", "giornate di degenza rapportate alla popolazione 75+", "population_75_plus"); }, sources: baseSources, note: "Rapporto tra giornate di degenza e residenti 75+. Va letto come pressione relativa del sistema ospedaliero nei territori piu anziani." };
    if (metric === "overview_beds_per_1000" || metric === "activity_beds_per_1000") return { label: "Posti letto per 1.000 residenti", tag: "posti letto", format: formatDecimal, unit: "posti letto per 1.000 residenti", rows: function () { return regionalMapSourceRows("beds_per_1000", "beds_year", "posti letto totali", "population_total"); }, sources: [{ id: "ministero_posti_letto_2023", label: "Ministero Salute" }, { id: "istat_posas_2026", label: "ISTAT popolazione" }], note: "Valore regionale rapportato alla popolazione residente. Trento e Bolzano sono aggregati solo in mappa per coerenza con la geometria regionale disponibile." };
    if (metric === "overview_beds_per_1000_over65" || metric === "activity_beds_per_1000_over65") return { label: "Posti letto per 1.000 residenti 65+", tag: "posti letto", format: formatDecimal, unit: "posti letto per 1.000 residenti 65+", rows: function () { return regionalMapSourceRows("beds_per_1000_over65", "beds_year", "posti letto rapportati alla popolazione 65+", "population_65_plus"); }, sources: [{ id: "ministero_posti_letto_2023", label: "Ministero Salute" }, { id: "istat_posas_2026", label: "ISTAT popolazione" }], note: "Dotazione di posti letto rapportata alla popolazione anziana; non misura personale disponibile o tempi di accesso." };
    if (metric === "overview_beds_per_1000_over75" || metric === "activity_beds_per_1000_over75") return { label: "Posti letto per 1.000 residenti 75+", tag: "posti letto", format: formatDecimal, unit: "posti letto per 1.000 residenti 75+", rows: function () { return regionalMapSourceRows("beds_per_1000_over75", "beds_year", "posti letto rapportati alla popolazione 75+", "population_75_plus"); }, sources: [{ id: "ministero_posti_letto_2023", label: "Ministero Salute" }, { id: "istat_posas_2026", label: "ISTAT popolazione" }], note: "Dotazione di posti letto rapportata alla popolazione 75+; utile nei confronti tra territori con strutture demografiche diverse." };
