(function () {
  ...
  function applyControlValue(name, value) {
    ...
    if (name === "securityDomain") {
      ...
      STATE.securityMeasure = value === "private_security_market" ? "NETTUR_MEUR||MIO_EUR" : "MIO_EUR";
      STATE.securityTransform = "value";
      STATE.securityYear = null;
    }
  ...
  function populateSecuritySpendingFilters(chartId) {
    ...
    keepValidSelection("securityMeasure", measureOptions, measureOptions[0] ? measureOptions[0].value : "MIO_EUR");
  ...
  function parseSecurityMeasure() {
    ...
    return { measureCode: STATE.securityMeasure || "MIO_EUR", unitCode: STATE.securityMeasure || "MIO_EUR" };
  }
  ...
  function securitySpendingSource() {
    ...
    return ui(
      "Fonte: Eurostat gov_10a_exp, spesa pubblica COFOG GF03 ordine pubblico e sicurezza; popolazione Eurostat demo_pjan per i valori per abitante. Elaborazione di Nazareno Lecis.",
      "Source: Eurostat gov_10a_exp, COFOG GF03 public order and safety; Eurostat demo_pjan population for per-inhabitant values. Processing by Nazareno Lecis."
    );
  }
